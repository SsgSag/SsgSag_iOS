...
class myPageMenuTableViewCell: UITableViewCell {
    ...
    private let menuTitleString: [String] = ["나의 이력", "알림 설정", "공지사항", "문의하기", "서비스 정보", "계정설정"]
    
    private let menuImageString: [String] = ["ic_jobSetting", "icAlarm", "icNotice", "icReport", "icServiceInfo", "settings"]
